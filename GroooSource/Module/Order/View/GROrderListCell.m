...
- (void)awakeFromNib {
    ...
    UITapGestureRecognizer *tapShopLogo = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapShopLogo)];
    [self.shopLogo addGestureRecognizer:tapShopLogo];
